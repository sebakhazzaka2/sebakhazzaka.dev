 ...
 *
 * El anillo de pulso replica el patrón animate-ping ya usado en los mockups
 * de Stitch (home.html, consultorio-case-study.html) como indicador de
 * disponibilidad/estado — acá cumple el mismo rol: atención sin ser un CTA
 * agresivo. motion-reduce lo apaga para quien pidió menos movimiento.
 */
export function WhatsappButton() {
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#25D366] opacity-75 motion-reduce:animate-none"
      />
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
